...
import { COLOR_SWATCHES } from '@/features/profile/constants/onboardingOptions';

export function SettingsPreferencesForm({ data, errors, onChange }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        />
        {errors.budgetSlider && (
          <p className="text-xs text-destructive">{errors.budgetSlider}</p>
        )}
      </div>
    </div>
  );
