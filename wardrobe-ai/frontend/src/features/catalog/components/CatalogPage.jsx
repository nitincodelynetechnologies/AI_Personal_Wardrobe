...
import { filterCatalogByCategory, buildMergedCatalog } from '@/features/catalog/services/catalogService';
import {
  GLOBAL_CATALOG_KEY,
...
export function CatalogPage() {
  ...
  const filteredProducts = useMemo(
    () => filterCatalogByCategory(buildMergedCatalog(), activeCategory),
  ...
  return (
    <DashboardLayout>
      <div className="flex h-full min-h-0 w-full overflow-hidden">
        ...
        <div className="scrollbar-hide min-h-0 flex-1 overflow-y-auto p-4 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] sm:p-6 md:pb-8 lg:p-8">
          <header className="mb-8 shrink-0 border-b border-borderColor pb-6">
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-700 dark:text-gray-400">
              Curated essentials from premium labels. Discover pieces that complement your
              virtual wardrobe.
            </p>
