...
export function OutfitGenerationLoader() {
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/50 px-4 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-2xl border border-violet/20 bg-white dark:bg-[#150d22] p-6 text-center shadow-2xl">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-violet/10">
          <Sparkles className="h-6 w-6 animate-pulse text-violet" />
        </div>
